...
public class WiFiDirectServicesList extends ListFragment {
    ...
    interface DeviceClickListener {
        ...
        void disconnectP2p(WiFiP2pService wifiP2pService);
    }
    ...
    //Fixme: change the simple_list_item_2 to another option for more control (like colors on activation)
    @Override
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        ((TextView) v.findViewById(R.id.text2)).setText("Connecting");
        //v.setBackgroundColor(getResources().getColor(R.color.custom_gold));
