//WORKS JUNE 19th, 2017!!
//Need to see if it can also do radio while FONA is on the Tx/Rx pins
//may have to switch to other hardware serial pins--see here:
//https://forum.arduino.cc/index.php?topic=341054.0
...
#define FONA_RX 1  //2
#define FONA_TX 0   //3; 12 Rx, 10 Tx on FONA
#define FONA_RST 6  //4
