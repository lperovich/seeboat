...
String varList[]={"deviceID", "GPStime", "waterVal", "tempVal", "condVal", "turbVal", "GPSlat", "GPSlong"};
...
//The structure of the data we're getting
struct dataPoint {
  byte deviceID;
  byte GPSlat;
  byte GPSlong;  
...
/////////////////////////////////////////////////////////////
//Function to set up radio, for the setup loop
void RxSetup(){
    pinMode(LED, OUTPUT);     
