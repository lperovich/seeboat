//LP August 2015
//Update Nov 2015: RG led fade only, fix HSV floor thing
//changed temperature range oct 2016 for sponsor week
...
//const int highReading1dec = 780; //85

const int lowReading1dec = 680; 
const int highReading1dec = 780; 
