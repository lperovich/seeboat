...
//I don't need to use this I should use the "double" one instead
String GPSgetplace(){
    String nowPlace;
    nowPlace="";
...
////////////////////////////////////////////////////////////////////////////// ARCHIVE
////////////////////////////////////////////////////////////////////////////// ARCHIVE
//modified from the flora_parsing sketch from adafruit tutorial
void GPSsetupOLD(){
  // connect at 115200 so we can read the GPS fast enough and echo without dropping chars
  // also spit it out
  Serial.begin(115200);
...
//////////////////////////////////////////////////////////////////////////////
//Function to measure the GPS info
//Note that this can spit out some weird values if the fix is off (zeros, or somethings seemingly random numbers)
void measureGPS(){
  //includes time, lat, long
  ...
  if (GPS.newNMEAreceived()) {
    ...
    if (GPS.fix) {
    //Update the data with our location
    //this is double
